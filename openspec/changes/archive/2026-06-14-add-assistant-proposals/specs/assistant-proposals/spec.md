...
When the assistant can neither answer a question from campaign data nor form a valid
proposal, it SHALL respond with a helpful message describing what it can do (answer questions
